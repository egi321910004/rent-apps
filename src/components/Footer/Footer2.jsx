            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="dark:text-body-color-dark  text-base leading-relaxed text-body-color">
                  Setiap template kami dibuat dengan mematuhi standar kualitas
                  internasional.
                </p>
                <div className="flex items-center">
                  <img
                    className="img-icon-footer card m-2"
                    src={smeAwards}
                    alt="SMEs Excellence Awards 2020"
                    style={{ width: "88px", height: "42px" }} // Adjust width and height as needed
                  />
                  <img
                    className="img-icon-footer card m-2"
                    src={atsiDigitalIcon}
