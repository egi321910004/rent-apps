...
import { FaArchway, FaBroom, FaList } from "react-icons/fa";
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <img src={Logo} alt="Logo" style={{ width: "200px" }} className="" />
        </NavLink>
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear box">
        {/* <!-- Sidebar Menu --> */}
